...
from feature_arrangers import arrange_features_randomly
...
def train_random_arrangement_model(data_dir='split_data', 
                                  target_shape=None, 
                                  batch_size=32, 
                                  epochs=50, 
                                  patience=10,
                                  ...
                                  weight_decay=0.0001,
                                  dropout_rate=0.5,
                                  experiment_name="random_cnn"):
    """
    Train a CNN model using randomly arranged features.
    ...
    # Arrange features randomly for CNN
    logger.log_message("Arranging features randomly...")
    arranged_features = arrange_features_randomly(norm_features_dict, target_shape)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train CNN model with randomly arranged features')
    ...
    parser.add_argument('--experiment', type=str, default='random_cnn', help='Experiment name for logging')
    ...
    # Train the model
    model, history, metrics = train_random_arrangement_model(
